              ...
              <NavigationMenuList className="gap-2">
                <NavigationMenuItem>
                  <Link href="/snippets" legacyBehavior passHref>
                    <NavigationMenuLink className="group flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-800/50 transition-colors">
          ...
          <div className="flex items-center gap-4">
            <SignedOut>
              <Button
                variant="outline"
                size="sm"
                className="border-amber-500/20 hover:border-amber-500/40 bg-gradient-to-r from-amber-500/10 
